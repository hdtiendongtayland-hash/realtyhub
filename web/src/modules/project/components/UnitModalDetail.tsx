...
const UnitModalDetail = ({
  ...
  return (
    <>
      ...
      <div className="flex h-full min-h-0 flex-col overflow-hidden lg:hidden max-md:h-auto max-md:min-h-full max-md:overflow-visible">
      ...
      <div className="no-scrollbar flex min-h-0 flex-1 overflow-hidden max-md:min-h-fit max-md:flex-none max-md:flex-col max-md:overflow-visible">
        ...
        <div className="flex w-1/2 shrink-0 flex-col overflow-hidden border-r border-gray-200 max-md:w-full max-md:overflow-visible max-md:border-r-0 lg:w-[42%]">
          ...
          <div className="no-scrollbar flex flex-1 flex-col overflow-y-auto pt-2 pr-1 max-md:overflow-visible max-md:pr-0 max-md:pt-3 lg:min-h-0">
        ...
        <div className="no-scrollbar w-1/2 overflow-y-auto pt-2 pl-1 max-md:w-full max-md:overflow-visible max-md:pl-0 max-md:pb-6 lg:flex lg:w-[58%] lg:min-h-0 lg:pl-3">
          <UnitModalInfo
        ...
        <div className="max-md:sticky max-md:bottom-0 max-md:z-10 max-md:-mx-3 max-md:bg-white max-md:px-3 max-md:shadow-[0_-6px_16px_rgba(15,23,42,0.08)]">
